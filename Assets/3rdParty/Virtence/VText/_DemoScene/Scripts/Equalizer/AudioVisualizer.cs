...
namespace Virtence.VText.Demo {
	...
	{	
	    ...
	    public VText DancingText;                           // the text which should work as an equalizer
	    ...
	    void Start()  
	    {
	        ...
	        for (int i = 0; i < DancingText.LayoutParameter.CurveXY.length; i++) {
	            DancingText.LayoutParameter.CurveXY.RemoveKey(i);    
	        }
	        ...
	        for (int i = 0; i < _samples.Length; i++) {
	            ...
	            DancingText.LayoutParameter.CurveXY.AddKey(key);
	        }
	    ...
	    IEnumerator Animate() {
	        while (true) {
	            ...
	            while (t < 1) {
	                ...
	                for (int i = 0; i < _samples.Length; i++) {   
	                    Keyframe key = DancingText.LayoutParameter.CurveXY[i];
	                    ...
	                    DancingText.LayoutParameter.CurveXY.MoveKey(i, key);
	                }
