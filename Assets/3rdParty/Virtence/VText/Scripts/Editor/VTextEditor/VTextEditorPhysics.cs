...
public class VTextEditorPhysics : AbstractVTextEditorComponent
{
    ...
    private bool ShowColliderEditor()
    {
        ...
        if (EditorGUILayout.BeginFadeGroup(_showCollider.faded))
        {
            ...
            {
                GUILayout.BeginHorizontal();
                PhysicsMaterial colMat = EditorGUILayout.ObjectField("Physic material:", _colliderMaterial.objectReferenceValue, typeof(PhysicsMaterial), false) as PhysicsMaterial;
